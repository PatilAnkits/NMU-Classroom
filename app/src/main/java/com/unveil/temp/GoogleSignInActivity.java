 ...
 */
public  class GoogleSignInActivity extends BasicActivity implements
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           updateUI(user);
                            ...
                            writeNewUser(user.getUid(), personName, personEmail ,photo);
                        } else {
    ...
    private void updateUI(FirebaseUser user) {
        hideProgressDialog();
        if (user != null) {
            startActivity(new Intent(this,PostViwer.class));
            finish();
        } else {
